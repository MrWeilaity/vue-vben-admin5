...
public class SysDictController {
    ...
    @PreAuthorize("hasAuthority('System:Dict:Edit')")
    public ApiResponse<Void> updateTypeStatus(@PathVariable Long id, @RequestBody DictTypeUpdateRequest request) {
    ...
    @PreAuthorize("hasAuthority('System:Dict:Edit')")
    public ApiResponse<Void> updateDataStatus(@PathVariable Long id, @RequestBody DictDataUpdateRequest request) {
